    ...
    <div class="col-md-12">
        <div class="panel-body"> 
            ...
            <h4><strong> Nº de pagamento({{$quant_pag}})</strong></h4>
              {!! Form::open(['route' => ['DeleteTodasPag'], 'method' => 'DELETE']) !!}

            {!! Form::submit("Excluir todos pagamentos", ['class' => 'btn btn-danger btn-lg']) !!}
...
<div class="alert alert-danger">
    <h4>Não existe pagamento para este dia!</h4>
</div>
<a href="{{route('pagamento.index')}}"><span class="glyphicon glyphicon-fast-backward"></span>Voltar</a>
