...
<head>
    ...
    <link rel="stylesheet" href="{{url('assets/datepicker/css/bootstrap.css.map')}}"/>
                        ...
                        <div class="container-fluid bg-primary">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand visible-xs" href="#" data-toggle="collapse"
                                    data-target="#bs-example-navbar-collapse-1" aria-expanded="false">Menu Principal</a>
                            </div>
                            <!--Cadastro-->
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                                            href="#">Cadastro<span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="{{ route('forma-pagamento.index') }}">Formas de pagamento</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <!--Debitos e créditos-->
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                            aria-haspopup="true" aria-expanded="false">Recebimentos<span
                                                class="caret"></span></a>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <li><a href="{{ route('recebimento.index') }}">Contas a Receber</a>
                                            <li><a href="{{ route('categoria_recebimento.index') }}">Categoria
                                                    Recebimento</a></li>
                                            <li><a href="{{ route('sub_categoria_recebimento.index') }}">Sub-Categoria
                                                    Recebimento</a></li>
                                            {{-- <li><a href="{{ route('getImportar') }}">Importar Planilha</a></li>
                                            <li><a href="{{ route('getExportar') }}">Exportar Planilha</a></li>
                                            <li><a href="{{ route('graficoRecebimento') }}">Gráfico de Recebimento</a>
                                            </li> --}}
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                            aria-haspopup="true" aria-expanded="false">Pagamentos<span
                                                class="caret"></span></a>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <li><a href="{{ route('pagamento.index') }}">Contas a Pagar</a>
                                            <li><a href="{{ route('categoria_pagamento.index') }}">Categoria
                                                    Pagamento</a></li>
                                            <li><a href="{{ route('sub_categoria_pagamento.index') }}">Sub-Categoria
                                                    Pagamento</a></li>
                                            {{-- <li><a href="{{ route('exportarPagamento') }}">Exportar excel Pagamento
                                                </a></li>
                                            <li><a href="{{ route('graficoPagamento') }}">Gráfico de pagamento </a> 
                                            </li> --}}
