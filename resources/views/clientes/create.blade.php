...
<div class="container-fluid">
    ...
    <!-- Link para voltar -->
    <a href="{{route('cliente.index')}}"><span class="glyphicon glyphicon-fast-backward"></span>Voltar</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                ...
                @if(isset($objCliente) && isset($objCliente->id) )
                <!-- Envia para Tela para editar -->
                {!! Form::model($objCliente, ['route' => ['cliente.update', $objCliente->id], 'class' => 'form', 'method' => 'put'])  !!}
                @else
            ...
            <div class="modal-body">  
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('nome_cliente', null, ['class' => 'form-control', 'placeholder' => 'Digite o cliente:']) !!}   
                    </div>
                </div>
