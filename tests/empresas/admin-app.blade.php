...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="{{url('//cdn.datatables.net/1.10.15/css/jquery.dataTables.min.css')}}"/>
    ...
    <body>
        ...
        <script src="{{url('//cdn.datatables.net/1.10.15/js/jquery.dataTables.min.js')}}"></script> 
        @stack('scripts')
