...
<!--            <link rel="stylesheet" href="../assets/css/main.css" />-->
            ...
            <?php
                ...
                $Novo_valor = Moeda_mysql($valor_rec); //Chama a função para converte o valor no formato do Real           
                ...
                $ObjContRec->setData_pagamento($data_paga);
                $ObjContRec->setDesconto($desconto);
                $ObjContRec->setJuros($juros);
